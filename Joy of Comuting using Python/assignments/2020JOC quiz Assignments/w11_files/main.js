      ...
      success: function(data, status, xhr) {
        ...
        try{
          if(file_type =="application/pdf"){
            ...
            $("#pdf-transcript-div").append('<object id="pdf_transcript_obj" data="' + subtitleLink + '#toolbar=0&navpanes=0" type="application/pdf" width="100%" height="300"></object>');
...
function setProgressState(el, state) {
  if (!el) return;
  if (state == 2) {
    el.src = '/assets/img/completed.png';
    el.alt = COMPLETED;
    el.title = COMPLETED;
  } else if (state == 1) {
    el.src = '/assets/img/in_progress.png';
    el.alt = 'In Progress';
